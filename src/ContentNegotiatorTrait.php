...
trait ContentNegotiatorTrait
{
     ...
     * a {@see \rock\core\filters\ContentNegotiatorFilter}
     ...
     * any of {@see \rock\core\filters\ContentNegotiatorFilter::$languages},
     * the first language in {@see \rock\core\filters\ContentNegotiatorFilter::$languages}
     ...
     * @throws FilterException if none of the requested content types is accepted.
     */
    protected function negotiateContentType(Request $request, Response $response)
    {
        if (!empty($this->formatParam) && ($format = Request::get($this->formatParam)) !== null) {
            if (in_array($format, $this->formats)) {
                ...
                throw new FilterException('The requested response format is not supported: ' . $format);
            }
        }
        ...
        throw new FilterException('None of your requested content types is supported.');
    }
